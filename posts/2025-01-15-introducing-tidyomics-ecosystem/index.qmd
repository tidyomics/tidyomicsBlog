...
tags:
  ...
  - tidyverse
  - bioconductor
description: "An introduction to the tidyomics ecosystem, including principles, core packages, publications, and community resources for tidy transcriptomics analysis."
format:
  html:
    toc: true
    toc-float: true
...
- *Mangiola S.*, Molania R., Dong R., Doyle M.A. & Papenfuss A.T. (2021). **“tidybulk: a tidy framework for modular transcriptomic data analysis.”** *Genome Biology* 22, 42. DOI [10.1186/s13059-020-02254-4](https://doi.org/10.1186/s13059-020-02254-4)
