...
With tidy transcriptomics, we differentiate the data container from the user interface. When we display, manipulate and visualise transcriptomic data, we might not care how the data is stored (tibble or hierarchical-rectangular structures) as long as the interface is consistent.
